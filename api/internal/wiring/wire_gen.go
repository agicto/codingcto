...
func InitApplication() (*app.Application, error) {
	...
	projectService := project.NewService(projectRepository, workspaceRepository, githubintegrationRepository, repocontextRepository, planningRepository, projectSkillStore, githubReadinessChecker, runtimeReadinessStore)
