...
func (h *Handler) RegisterRoutes(r *router.Router) {
	r.Group("", func(auth *router.Router) {
		...
		auth.POST("/agent-tasks/:id/events", h.CreateDirectTaskEvent).Name("codingcto.agent_tasks.events.store").WhereNumber("id")
		auth.POST("/agent-tasks/:id/result", h.SubmitDirectTaskResult).Name("codingcto.agent_tasks.result.store").WhereNumber("id")
