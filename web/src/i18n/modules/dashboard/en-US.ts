...
const messages: DashboardMessages = {
  ...
  specForge: {
    ...
    launch: {
      ...
      workspaceDescription: 'Global CodingCTO is for experiments. Enterprise work should start from a workspace and project so GitHub bindings, skills, and execution history stay scoped.',
      selectWorkspace: 'Select workspace',
      noWorkspace: 'No workspace yet. Create one here to unlock project flows.',
      noWorkspaceDescription: 'No workspace description yet.',
      projects: 'Projects',
      open: 'Open',
      createWorkspace: 'Create workspace',
      workspaceName: 'Workspace name',
      workspaceSlug: 'Workspace slug',
      workspaceDescriptionPlaceholder: 'Who owns this product portfolio?',
      workspaceDescriptionLabel: 'Workspace description',
      creatingWorkspace: 'Creating workspace',
      projectTitle: 'Project setup',
      projectDescription: 'Create the project boundary, then open it for repository binding and enterprise CodingCTO runs.',
      projectName: 'Project name',
      projectSlug: 'Project slug',
      projectDescriptionPlaceholder: 'What product or system does this project represent?',
      projectDescriptionLabel: 'Project description',
      createProject: 'Create project',
      creatingProject: 'Creating project',
      workspaceRequired: 'Workspace name and slug are required.',
      workspaceCreated: 'Workspace "{name}" created. Create or open a project next.',
      workspaceCreateFailed: 'Workspace could not be created. Try another slug or check backend auth.',
      projectWorkspaceRequired: 'Create or select a workspace before creating a project.',
      projectRequired: 'Project name and slug are required.',
      projectCreated: 'Project "{name}" created. Open it to continue with Git binding.',
      projectCreateFailed: 'Project could not be created. Try another slug or check the selected workspace.',
      workspaceApiUnavailable: 'Workspace API unavailable. Sign in with backend auth and confirm the API is running.',
    },
  },
  projectsConsole: {
