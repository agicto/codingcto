...
const messages: DashboardMessages = {
  ...
  projectDelivery: {
    ...
    bindPanel: {
      ...
      description: 'Select a repository already connected in Settings > GitHub. Primary repositories are writable; dependency, docs, and infra repositories become read-only planning context.',
      ...
      allRepositoriesBound: 'Every connected GitHub repository in this workspace is already bound to this project.',
    ...
    readiness: {
      ...
      repository: {
        ...
        primaryRemoveBlocked: 'The primary repository cannot be removed directly. Bind another primary repo or adjust the execution boundary first.',
      },
    },
  },
};
