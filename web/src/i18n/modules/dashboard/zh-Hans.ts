...
const messages = {
  ...
  specForge: {
    ...
    launch: {
      ...
      workspaceDescription: '全局 CodingCTO 适合实验。企业交付应从工作区和项目开始，让 GitHub 绑定、技能和执行历史都有明确边界。',
      selectWorkspace: '选择工作区',
      noWorkspace: '暂无工作区。请先在这里创建，解锁项目流程。',
      noWorkspaceDescription: '暂无工作区描述。',
      projects: '项目',
      open: '打开',
      createWorkspace: '创建工作区',
      workspaceName: '工作区名称',
      workspaceSlug: '工作区标识',
      workspaceDescriptionPlaceholder: '这个产品组合由谁负责？',
      workspaceDescriptionLabel: '工作区描述',
      creatingWorkspace: '正在创建工作区',
      projectTitle: '项目设置',
      projectDescription: '创建项目边界，然后进入项目绑定仓库并执行企业级 CodingCTO 流程。',
      projectName: '项目名称',
      projectSlug: '项目标识',
      projectDescriptionPlaceholder: '这个项目代表哪个产品或系统？',
      projectDescriptionLabel: '项目描述',
      createProject: '创建项目',
      creatingProject: '正在创建项目',
      workspaceRequired: '请填写工作区名称和标识。',
      workspaceCreated: '工作区“{name}”已创建。接下来可以创建或打开项目。',
      workspaceCreateFailed: '工作区创建失败。请换一个标识，或检查后端登录状态。',
      projectWorkspaceRequired: '请先创建或选择工作区，再创建项目。',
      projectRequired: '请填写项目名称和标识。',
      projectCreated: '项目“{name}”已创建。打开项目继续绑定 GitHub。',
      projectCreateFailed: '项目创建失败。请换一个标识，或检查当前工作区。',
      workspaceApiUnavailable: '工作区 API 不可用。请确认后端已启动，并且后端登录态有效。',
    },
  },
  projectsConsole: {
    eyebrow: '项目控制台',
