...
const messages = {
  ...
  projectsConsole: {
    ...
    newProject: {
      ...
      emptyRepositoriesDescription: '先连接 GitHub App 并同步授权仓库，然后再回到这里导入项目。',
  ...
  projectOverview: {
    ...
    repositories: {
      ...
      availableRepositories: 'GitHub App 已授权仓库',
      authorizedCount: 'GitHub App 已授权 {count} 个',
      ...
      allAuthorizedBoundHint: '当前已授权仓库都已绑定。要添加更多仓库，请先在 GitHub App 中授权更多仓库，再回到这里绑定。',
      manualRepositoriesTitle: '需要 GitHub App 授权的仓库',
      manualRepositoriesDescription:
        '这些仓库记录是手工添加的，或创建于 GitHub App 同步之前。请先在 GitHub 授权并重新同步，再用于交付。',
      needsAppAuthorization: '需要 GitHub App 授权',
      primaryAction: '设为主仓库',
      contextAction: '作为上下文',
