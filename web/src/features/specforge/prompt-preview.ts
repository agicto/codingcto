...
export function buildPromptPreview(plan: PlanBundle, node: PRNode) {
  return [
    ...
    '',
    'Constraints:',
    '- Keep this PR scoped to the node goal.',
    '- Do not implement non-goals.',
    '- Follow the detected repository profile and existing conventions.',
    '',
    'After implementation:',
    '- Run the listed tests.',
    '- Commit the changes.',
    '- Prepare a PR summary with scope, non-goals, risks, and test plan.',
  ].join('\n');
}
